                ...
                <Card className="bg-transparent border-none shadow-none">
                    <CardHeader>
                        ...
                        <CardDescription className="text-justify">
                            We are thrilled to see you again. Log in to rediscover your favorite tunes and the latest
                            music trends.
                        </CardDescription>
                    </CardHeader>
                    <form action={"/api/auth/callback/credentials"} method={"POST"} onSubmit={onLogin}>
                        ...
                        <CardFooter className="justify-around flex-col gap-4">
                            <Button type={"submit"} className="w-full bg-violet-950 hover:bg-violet-800">Login</Button>
            ...
            <TabsContent value="signup">
                <Card className="bg-transparent border-none shadow-none">
                    <CardHeader>
                        ...
                        <CardDescription className="text-justify">
                            Your musical journey starts here! Stay connected with your favorite artists and discover new
                            tracks.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-2">
