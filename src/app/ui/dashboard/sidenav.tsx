        ...
        <div>
            <div className="flex md:h-screen flex-col px-3 py-4 md:px-4 justify-between md:pb-11 ">
                <div className="flex md:h-screen flex-col justify-between">
                    <SheetSide/>
                    <div
                        className="ml-3 fixed rounded-md bg-violet-950 md:bg-neutral-900 bottom-0 right-0  left-0 lg:static md:static flex grow flex-row  space-x-2 md:flex-col md:space-x-0 md:space-y-1">
                        <NavLinks/>
                    </div>
