...
import {GET_ALL_ARTISTS, GET_ALL_GENRES, GET_ALL_TRACKS, GET_ALL_USERS, GET_ARTIST} from "@/graphql/queries";
    ...
    return (
        <div className="scrollable-container">
            <div
                ...
                {data?.genres.map((track: any, index: React.Key | null | undefined) => (
                    <Link
                        href={{
                    ...
                    >
                        ...
                        <SingerCard artist={track}></SingerCard>
                    </Link>
                ))}
            </div>
        </div>
